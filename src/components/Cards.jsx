...
////w-full py-[10rem] px-4 bg-white
//Full width componenet and use grid to show three columns
//md:grid-cols-3-Only show 3 cols when above medium otherwise stacked

//                <img className='w-20 mx-auto mt-[-3rem] bg-white' src={Single} alt='/'/>
//width of 20 nimage shrunk mx-auto sits middle of component
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
                <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    ...
                    <div className='text-center font-medium'>
                        ...
                        <p className='py-2 border-b mx-8'>Unlimited Calls</p>
